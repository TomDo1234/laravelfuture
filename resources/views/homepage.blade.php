    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div id="logo">
					<a href="https://iifuture.net" title="Future Corporation – Sign and Graphics Software"><img src="https://iifuture.net/wp-content/uploads/2013/11/future_corporation_logo.png" alt="Future Corporation – Sign and Graphics Software"></a>
				</div>
                </div>
